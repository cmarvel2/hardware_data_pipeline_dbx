...
from local_data_collection.sensor_polling.hardware_sensor_collectors import (
    get_cpu_data,
    get_gpu_data,
    get_memory_data,
    init_computer,
...
def main():
    ...
    try:
        ...
        logger.exception(f"Error in sensor collection, test id: {test_id}")
        raise
