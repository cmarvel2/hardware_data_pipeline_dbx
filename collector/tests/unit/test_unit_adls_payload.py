...
def test_check_buffer_returns_whether_limit_is_reached(
    ...
    buffer = adls_payload.UploadMemory()
    buffer.payload.snapshots = [HardwareDataStorage(None, "hw", "sensor", "Load", 1.0) for _ in range(snapshot_count)]
...
def test_upload_blob_completes_and_uploads_json(
    ...
    fixed_time = datetime(2026, 9, 6, 15, 40, 0, tzinfo=UTC)
    ...
    expected_blob_name = (
        "incoming/ingest_date=2026-09-06/hardware_sensor_data_20260906_154000_12345678-1234-5678-1234-567812345678.json"
    )
